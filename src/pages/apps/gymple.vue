...
<div class="bg-grey-8 text-center">
  ...
  <div class="text-h3 q-mb-sm">Gymple</div>

  <q-btn round flat class="redirect q-mt-lg" type="a" href="https://apps.apple.com/gb/app/gymple/id1577811006" target="_blank">
  ...
  <div class="col justify q-pa-md">
    <q-img src="../../assets/gymple_3.png" style="max-width: 300px" spinner-color="black" />
        ...
        <template v-slot:avatar>
          <q-icon name="policy" color="primary" />
            ...
            <strong>Privacy Policy</strong> <p>
                  William Coates built the Gymple app as
                  ...
                  Gymple unless otherwise defined in this Privacy Policy.
