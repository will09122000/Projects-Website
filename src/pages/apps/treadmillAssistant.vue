...
<div class="bg-grey-8 text-center">
  ...
  <div class="row justify-center">
    ...
    <q-img src="../../assets/tread_assistant_4.png" spinner-color="white" width="50%" style="max-width: 500px" class="q-my-lg"/>
  </div>
        ...
        <template v-slot:avatar>
          <q-icon name="policy" color="primary" />
            ...
            <strong>Privacy Policy</strong> <p>
                  ...
                  Privacy Policy, do not hesitate to contact me at will0912@icloud.com.
