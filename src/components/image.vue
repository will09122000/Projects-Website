<template>
  <div>
    <q-dialog v-model="fullscreen" persistent :maximized="maximizedToggle">
    ...
    <q-img :src="require(`../assets/${filename}`)" spinner-color="white" :style="style">
...
export default {
  ...
  props: ['filename', 'imageDescription', 'caption', 'style']
}
</script>
